...
TESTS = [
    # ── HAEMATOLOGY (CBC) ───────────────────────────────────────────
    ("HAEM", "CBC-HB", "Haemoglobin", "g/dL", "Photometric", "Whole Blood EDTA",
        [("M", None, None, "13.0", "17.0", ""), ("F", None, None, "12.0", "15.5", "")], ""),
    ("HAEM", "CBC-RBC", "RBC Count", "million/µL", "Impedance", "Whole Blood EDTA",
        [("M", None, None, "4.5", "5.9", ""), ("F", None, None, "4.1", "5.1", "")], ""),
    ("HAEM", "CBC-WBC", "Total WBC Count", "×10³/µL", "Impedance", "Whole Blood EDTA",
        [("A", None, None, "4.0", "10.0", "")], ""),
    ("HAEM", "CBC-PLT", "Platelet Count", "×10³/µL", "Impedance", "Whole Blood EDTA",
        [("A", None, None, "150", "450", "")], ""),
    ("HAEM", "CBC-HCT", "Haematocrit (PCV)", "%", "Calculated", "Whole Blood EDTA",
        [("M", None, None, "40", "50", ""), ("F", None, None, "36", "46", "")], ""),
    ...
    ("HAEM", "CBC-MCHC", "MCHC", "g/dL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "32", "36", "")], ""),
    ("HAEM", "CBC-RDW", "RDW (Red cell Distribution Width)", "%", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "11.5", "15.5", "")], ""),
    ("HAEM", "CBC-MPV", "MPV (Mean Platelet Volume)", "fL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "6.8", "10.4", "")], ""),
    # Differential leukocyte count (%)
    ("HAEM", "DLC-NEUT", "Neutrophils", "%", "Microscopy / Impedance", "Whole Blood EDTA",
        [("A", None, None, "40", "80", "")], ""),
    ("HAEM", "DLC-LYMP", "Lymphocytes", "%", "Microscopy / Impedance", "Whole Blood EDTA",
        [("A", None, None, "20", "45", "")], ""),
    ("HAEM", "DLC-MONO", "Monocytes", "%", "Microscopy / Impedance", "Whole Blood EDTA",
        [("A", None, None, "2", "10", "")], ""),
    ("HAEM", "DLC-EOSI", "Eosinophils", "%", "Microscopy / Impedance", "Whole Blood EDTA",
        [("A", None, None, "1", "6", "")], ""),
    ("HAEM", "DLC-BASO", "Basophils", "%", "Microscopy / Impedance", "Whole Blood EDTA",
        [("A", None, None, "0", "2", "")], ""),
    # Absolute counts
    ("HAEM", "ABS-NEUT", "Absolute Neutrophil Count", "/µL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "2000", "7000", "")], ""),
    ("HAEM", "ABS-LYMP", "Absolute Lymphocyte Count", "/µL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "1000", "3000", "")], ""),
    ("HAEM", "ABS-MONO", "Absolute Monocyte Count", "/µL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "200", "1000", "")], ""),
    ("HAEM", "ABS-EOSI", "Absolute Eosinophil Count", "/µL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "20", "500", "")], ""),
    ("HAEM", "ABS-BASO", "Absolute Basophil Count", "/µL", "Calculated", "Whole Blood EDTA",
        [("A", None, None, "0", "100", "")], ""),
...
TEMPLATES = [
    {"code": "CBC", "name": "Complete Blood Count (CBC)",
     "tests": ["CBC-HB", "CBC-RBC", "CBC-WBC", "CBC-PLT", "CBC-HCT", "CBC-MCV", "CBC-MCH", "CBC-MCHC",
               "CBC-RDW", "CBC-MPV", "DLC-NEUT", "DLC-LYMP", "DLC-MONO", "DLC-EOSI", "DLC-BASO",
               "ABS-NEUT", "ABS-LYMP", "ABS-MONO", "ABS-EOSI", "ABS-BASO", "ESR"]},
    ...
    def handle(self, *args, **opts):
        ...
        for t in TEMPLATES:
            tmpl, _ = ReportTemplate.objects.update_or_create(
                ...
                defaults={"name": t["name"], "pdf_template_path": "pdf/reports/generic.html"},
            )
